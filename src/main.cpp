...
void MainLoop()
{
    ...
    while (!done)
    {
        ...
        // NOTE: Empty braces are created to compact the scope for the window variables (I don't know why).
        {
        ...
        // Rendering
        ImGui::Render();
        const float clear_color_with_alpha[4] = {0.5, 0.5, 0.5, 1.0};
...
// Helper functions (from example script)
